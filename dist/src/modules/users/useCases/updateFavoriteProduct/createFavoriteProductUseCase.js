...
var CreateFavoriteProductUseCase = /** @class */ (function () {
    function CreateFavoriteProductUseCase(productsRepository, usersRepository) {
        this.productsRepository = productsRepository;
        this.usersRepository = usersRepository;
    }
    CreateFavoriteProductUseCase.prototype.execute = function (_a) {
        var products_ids = _a.products_ids, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var favoritesProducts, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.productsRepository.findByIds(products_ids)];
                    case 1:
                        favoritesProducts = _b.sent();
                        return [4 /*yield*/, this.usersRepository.findById(user_id)];
                    case 2:
                        user = _b.sent();
                        if (!favoritesProducts) {
                            throw new AppError_1.AppError("Products not found");
                        }
                        if (!user) {
    ...
    CreateFavoriteProductUseCase = __decorate([
    ...
    return CreateFavoriteProductUseCase;
}());
