...
var UsersRepository = /** @class */ (function () {
    function UsersRepository() {
        this.ormRepository = (0, typeorm_1.getMongoRepository)(User_1.User);
    }
    UsersRepository.prototype.create = function (_a) {
        var id = _a.id, name = _a.name, email = _a.email, password = _a.password, favorites_products = _a.favorites_products;
    ...
    UsersRepository.prototype.update = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.update(id, data)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
